  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="md:hidden lg:flex justify-center">
        ...
        >
          <span className="text-white mr-1">Sujal </span>
          <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">Parmar</span>
        </Link>
      </div>
      ...
      <div className="md:hidden">
        ...
        {open && (
          <motion.div
            ...
            initial="closed"
            animate="opened"
            className="absolute left-0 top-0 w-[100%] h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-4xl"
          >
            {links.map((link) => (
